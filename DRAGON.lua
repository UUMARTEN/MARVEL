...
{{text = '𝑑𝑒𝑣 𝐵𝑟𝑖𝑛𝑔𝑜', url="t.me/BringoXx"}},
{{text = '𝑑𝑒𝑣 𝑑𝑒𝑘𝑎', url="t.me/YY_OIO"}},
{{text = '𝑑𝑒𝑣 𝑒𝑙𝑘𝑎𝑝𝑜𝑜𝑠',url="t.me/G_W_P"}},
{{text = '〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉', url="t.me/G_K_00"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'كابوس' or text == 'مبرمج السورس' or text == 'كابوس مبرمج السورس' or text == 'الهقر' then
local Text =[[
 ☆ المبرمج كابوس لو حابب تتواصل معاه ☆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑑𝑒𝑣 𝑒𝑙𝑘𝑎𝑝𝑜𝑜𝑠',url="t.me/G_W_P"}},
...
send(msg.chat_id_, msg.id_, "لا يجوز حظر كابوس عام لانه هكر 🌚😹")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1851380322) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم كابوس عام لانه هكر 🌚😹")
return false 
end
...
keyboard.inline_keyboard = {
{
{text = 'english 𝅘𝅥𝅮', callback_data="/cv-marten"},{text = 'عربي 𝅘𝅥𝅮', callback_data="/help90"},
},
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/G_K_00 "},
},
...
keyboard.inline_keyboard = {
{
{text = '☊.BACK.☊', callback_data="/cv-marten"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
