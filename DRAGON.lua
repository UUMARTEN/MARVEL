...
if res ~= 200 then
print('\27[0;31m༆╾╾╾╾〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m༆╾╾╾╾〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "༆╾╾╾╾[〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩 ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "༆╾╾╾╾[〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩 ༆╾╾╾╾〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩 ┉"
exit 1
fi
if [ ! $token ]; then
echo "༆╾╾╾╾〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩 ༆╾╾╾╾〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩 ┉ ┉"
...
sudo_users = {SUDO,1814415004,1335307516,1914852231}   
...
if text == "غنيلي" or text = '/ganel' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
{
{text = 'اغـنـيه اخـري', callback_data="/ganel"},
},
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/G_K_00)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/G_K_00)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/G_K_00)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/G_K_00)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/G_K_00)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/G_K_00)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/G_K_00)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/G_K_00)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/G_K_00)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/G_K_00)') 
return false
end
...
return https.request("https://api.telegram.org/bot"..token..'/editVoice?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end
