...
sudo_users = {SUDO,1911032583,1335307516,1914852231}   
...
if tonumber(user_id) == tonumber(1911032583) then  
var = true
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑑𝑒𝑣 𝐵𝑟𝑖𝑛𝑔𝑜', url="t.me/BringoXv"}},
...
local Name = " ● DEV NAME ↣['..result.first_name_..'](tg://user?id='..result.id_..')\n ● DEV USER ↣ '@'..result.username_ "
keyboard = {} 
keyboard.inline_keyboard = {
{
...
keyboard.inline_keyboard = {
{
{text = '𝑑𝑒𝑣 𝐵𝑟𝑖𝑛𝑔𝑜', url="t.me/BringoXv"},{text = '𝑑𝑒𝑣 𝑑𝑒𝑘𝑎', url="t.me/YY_OIO"},
},
...
if tonumber(result.sender_user_id_) == tonumber(1911032583) then  
...
if result.id_ == tonumber(1911032583) then
...
if tonumber(userid) == tonumber(1911032583) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ☆")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'G_K_00')..')'
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/G_K_00)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
