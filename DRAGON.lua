...
if [ ! $token ]; then
echo "༆╾╾╾╾〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩 ༆╾╾╾╾〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩 ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE MARTEN.lua \e[0m"
echo "༆╾╾╾╾〈〉〈•`𝑠𝑜𝑢𝑟𝑐𝑒☆𝑚𝑎𝑟𝑣𝑒𝑙`•〉〈〉╾╾╾╾〩 ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./MARTEN.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
{
{text = 'اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./MARTEN.lua").botUserName.."?startgroup=start"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
