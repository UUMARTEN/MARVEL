...
if text == 'مارتن' or text == 'مبرمج السورس' or text == 'مارتن مبرمج السورس' or text == 'الهقر' or text == 'توام الكابوس' then
local Text =[[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '.𓅓 𝐄 𝐒 𝐋 𝐀 𝐌 𓅓.',url="t.me/Al_forma"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/19&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = '𝚂??𝚄??𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☆', url="t.me/G_K_00"}},
}  
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
UrlAntk = https.request('https://Antk.php?abs='..URL.escape(textntk)..'')   
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_T_N/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,msg.id_, '[بيي حته مني ..☁️⁦❤️](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/SO_ROGEN)')
return false
end
end
end
