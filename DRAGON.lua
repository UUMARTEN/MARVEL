...
sudo_users = {SUDO,1851380322,1744196893,1839082644}   
...
if DevSoFi(msg) then
local bl = '◍ مرحبا بك في اوامر المطور الجاهزه \n◍ [قناة السورس](t.me/SO_ROGEN)'
local keyboard = {
{'مبرمج السورس²','مطور السورس','مبرمج السورس¹'},
{'ضع اسم للبوت'},
...
local bl = 'مرحبا بك في اوامر التعطيل..🌚❤️'
local keyboard = {
{'تعطيل الاذاعه'},
{'تعطيل التواصل'},
{'تعطيل المغادره'},
...
local bl = 'مرحبا بك في اوامر الردود..🥺❤️'
local keyboard = {
...
local Text = [[ 
[اضـغـط هنا ؤانـضــم الـي قنــاه السـورس❤️.](t.me/SO_ROGEN)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[اضـغـط هنـا لـؤ عـايـز بـؤت عـلـي سـورس رؤججــيـن❤️.](t.me/SO_ROGEN)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚍𝚎𝚟 𝚖𝚊𝚛𝚝𝚎𝚗',url="t.me/I_C_X"}},{{text = '𝚍𝚎𝚟 𝚎𝚕𝚔𝚊𝚋𝚘𝚘𝚜', url="t.me/G_W_P"}},
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[اضـغـط هنـا لـؤ حـابب تـتــواصــل معـاه مبـرمـجـيـن سـورس رؤججــيـن❤️.](t.me/SO_ROGEN)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚍𝚎𝚟 𝚖𝚊𝚛𝚝𝚎𝚗',url="t.me/I_C_X"}},{{text = '𝚍𝚎𝚟 𝚎𝚕𝚔𝚊𝚋𝚘𝚘𝚜', url="t.me/G_W_P"}},
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
الـكــابــوس مبــرمـجج ســورس روجــين لـوححـابب تتـواصـل معـاه ❤️.
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
مـــارتــن مبــرمـجج ســورس روجــين لـوححـابب تتـواصـل معـاه ❤️.
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local DRAGON_Msg = { 
'◍ مرحبا انا بوت اسمي '..Namebot..' اختصاصي حمايه المجموعات من التخريب والتفليش الخ.. قم باضفاتي الي مجموعتك الان..🙂❤️',
} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚍𝚎𝚟 𝚎𝚕𝚔𝚊𝚋𝚘𝚘𝚜', url="t.me/G_W_P"}},{{text = '𝚍𝚎𝚟 𝚖𝚊𝚛𝚝𝚎𝚗',url="t.me/I_C_X"}},
{{text = '𝚍𝚎𝚟 𝚊𝚕𝚖𝚊𝚐𝚔',url="t.me/M_A_G_K"}},
{{text = '𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗', url="t.me/SO_ROGEN"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=start"}},
}
...
if text == 'مارتن' or text == 'مبرمج السورس' or text == 'المبرمج مارتن' or text == 'قلب الكابوس' then
local Text =[[
مـــارتــن مبــرمـجج ســورس روجــين لـوححـابب تتـواصـل معـاه ❤️.
]]
keyboard = {} 
...
if text == 'كابوس' or text == 'الكابوس' or text == 'محمد' or text == 'مبرمج سورس روجين' then
local Text = [[
الـكــابــوس مبــرمـجج ســورس روجــين لـوححـابب تتـواصـل معـاه ❤️.
]]
keyboard = {} 
...
if text == 'كريم' or text == 'الماجيك' or text == 'مطور السورس' then
local Text = [[
الــمـاجـيـك مـطـور ســورس روجــين لـوححـابب تتـواصـل معـاه ❤️.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚍𝚎𝚟 𝚊𝚕𝚖𝚊𝚐𝚔',url="t.me/M_A_G_K"}},
...
local Text = [[
[اضـغـط هـنـا لـتـؤاصـل مـع مـبـرمـجـيـن الـسـؤرس❤️.](t.me/US_ROGEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚞𝚜𝚎𝚛𝚜 𝚛𝚘𝚘𝚐𝚎𝚗', url="t.me/US_ROGEN"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/US_ROGEN/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
◍ لعبة البـات ↤ بات
┄─━━━━𝚛𝚘𝚘𝚐𝚎𝚗━━━━─┄
◍ CH -> ┄─━━━━[𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗](t.me/SO_ROGEN)━━━━─┄
┄─━━━━𝚛𝚘𝚘𝚐𝚎𝚗━━━━─┄
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
"‏ ‏أحببتك وأنا منطفئ، فما بالك وأنا في كامل توهجي ؟ 🙂 .!",
"‏من ترك أمرهُ لله، أعطاه الله فوق ما يتمنَّاه💙 ",
"‏ إنعدام الرّغبة أمام الشّيء الّذي أدمنته ، انتصار. ↤❤️",
"‏ ‏كل العالم يهون بس الدنيا بينا تصفي 💙 ",
"‏ إن الأمر ينتهي بِنا إلى أعتياد أي شيء. 😚 ",
"‏ إنعدام الرّغبة أمام الشّيء الّذي أدمنته ، انتصار. 💝",
"‏ لا تعودني على دفء شمسك، إذا كان في نيتك الغروب .َ 🙂 .!",
...
{{text = '𝚜𝚘𝚞𝚛𝚌𝚎 𝚖𝚊𝚛𝚟𝚎𝚕◍', url="t.me/SO_ROGEN"}},
}  
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_, msg.id_, " ◍ لا تسطيع كتم مطور سورس روجين")
return false 
end
...
send(msg.chat_id_, msg.id_, " ◍ لا يمكنك حظر مطور سورس روجين\n")
return false 
end
...
if result.id_ == tonumber(1744196893) then
send(msg.chat_id_, msg.id_, " لا يمكنك كتم مطور سورس روجين ◍\n")
return false 
end
usertext = '\n ◍ العضو ↤ ['..result.title_..'](t.me/'..(username or 'SO_ROGEN')..')'
status  = '\n ◍ تم كتمه عام من {'..Groups..'} مجموعه'
...
local timezone = "الساعه الان : "..time.."\nالتاريخ : "..os.date("%Y/%m/%d") 
...
send(msg.chat_id_,msg.id_,'◍ انت مطور يقلبيتي..🌚❤️')
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_,'◍ نت المالك ونملكك..🥺❤️')
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_,'◍ انت المنشئ ياروحي ..🥺❤️')
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_,'◍ انت المنشئ الاساسي ياسطا..😹❤️')
return false
end
...
send(msg.chat_id_,msg.id_,'◍ انت ادمن الله يسهلو..😹❤️')
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_,'◍ نت عضو مميز يعني متميز..😹❤️')
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_,'◍ انت عضو قمر هنا..😹❤️')
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '◍ متبقاش تقطع الجوبات..😂❤️') 
return false
end

if text == 'عامل اي' then 
send(msg.chat_id_,msg.id_, '◍ عامل جمعيه..🙄❤️ ') 
return false
end
...
send(msg.chat_id_,msg.id_, '◍ باي ياحته مني..🥺❤️') 
return false
end
...
send(msg.chat_id_,msg.id_, '◍ العفو ياروحي..🌚❤️') 
return false
end

if text == 'هلو' or text == 'هلا' then
send(msg.chat_id_,msg.id_, '◍ هلا بيك ياروحي..❤️') 
return false
end
...
send(msg.chat_id_,msg.id_, '◍ محصلش بطل تطبيل..🙄❤️') 
return false
end

if text == 'زخرفه' or text == 'زخرفة' then
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه روجين') 
return false
end

if text == 'بحبك' or text == 'حبق' then
send(msg.chat_id_,msg.id_, '◍ بعشء امك..🥺❤️') 
return false
end
...
if text == '😂😂😂' or text == '😂😂😂😂' then
send(msg.chat_id_,msg.id_, '◍ دامت ضحكتك يابيبي..🥺❤️') 
return false
end
...
send(msg.chat_id_,msg.id_, '◍ فلخاص بيخصخص..😂❤️') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '◍ تؤ تعاله انته..🥺❤️') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '◍ مين مؤدب ناوو..😹❤️') 
return false
end

if text == 'مش هتيجي' or text == 'تجي' then
send(msg.chat_id_,msg.id_, '◍ عب يلمبي عب 🙂😹') 
return false
end

if text == 'هخخ' or text == 'خخ' then
send(msg.chat_id_,msg.id_, '◍ واحده وحده بمت😂😂') 
return false
end
...
send(msg.chat_id_,msg.id_, '◍ ونت مالك ياحشري..🙄❤️') 
return false
end
...
send(msg.chat_id_,msg.id_, '◍ يوه خضتني ياسمك اي..🥺❤️') 
return false
end
...
send(msg.chat_id_,msg.id_, '◍ بدمنك ياعيوني..🥺❤️') 
return false
end

if text == 'عيب' or text == 'لا عيب' then
send(msg.chat_id_,msg.id_, '◍ سيب الواد يلعب..🙄❤️') 
return false
end

if text == 'هه' or text == 'ههه' then
send(msg.chat_id_,msg.id_, '◍ ضحكه مش سالكه زيك..😹❤️') 
return false
end

if text == 'تؤ' or text == 'تؤ تؤ' then
send(msg.chat_id_,msg.id_, '◍ يانوحي يانوحي..🥺❤️') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '◍ يتي كبرت وبقيت بتشبك الكلام..🥺❤️') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '◍ انا وحده نسوان ونت مين..😂❤️') 
return false
end
end
end
...
local sofia = {
" ◍ قمر ياروحي خد ممح..💋❤️",
" ◍ صوتك عفنت غيرها بقي..❤️",
" ◍ يتي القمر نزل الارض يعمل اي🥺",
" ◍ قلبي موجود فصوره .. 🥺❤️",
" ◍ الله ع جمالك ياقمري..🥺❤️",
}
...
[[
◍ŭ̈s̆̈ĕ̈r̆̈n̆̈ă̈m̆̈ĕ̈ #username  
◍ s̆̈t̆̈ă̈s̆̈t̆̈ #stast  
◍ ĭ̈d̆̈ #id  
◍ ğ̈ă̈m̆̈ĕ̈ #game 
◍m̆̈s̆̈ğ̈s̆̈ #msgs
◍ b̆̈ĭ̈ŏ̈ #bio
...
[[
✪ u͜͡s͜͡e͜͡r͜͡n͜͡a͜͡m͜͡e͜͡ #username  
✪ s͜͡t͜͡a͜͡s͜͡t͜͡ #stast  
✪ i͜͡d͜͡ #id  
✪ g͜͡a͜͡m͜͡e͜͡ #game 
✪ m͜͡s͜͡g͜͡s͜͡ #msgs
✪ b͜͡i͜͡o͜͡ #bio
...
┄─━━━━[𝚛𝚘𝚘𝚐𝚎𝚗](t.me/SO_ROGEN)━━━━─┄
◍ اليك الاوامر الخاص بسورس روجين .
