...
local UUE_C = database:get(bot_id..'text:ch:user')
if UUE_C then
send(msg.chat_id_, msg.id_,'['..UUE_C..']')
else
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/UUE_C)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎', url="t.me/UUE_C"}}, 
} 
...
database:del(bot_id..'Srt:Bot')
local Text = [[
[مرحبا بك في سورس مارفل لقمد لتنصيب بوت علي سورس مارفل تواصل مع اي مطور](t.me/UU_MARVEL)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚍𝚎𝚟 𝙱𝚛𝚒𝚗𝚐𝚘', url="t.me/BringoXx"}},
{{text = '𝚍𝚎𝚟 𝚍𝚎𝚔𝚊', url="t.me/YY_OIO"}},
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UUE_C')..') \n ☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☆ العضو : {["..data.first_name_.."](T.ME/UUE_C)}\n ☆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆ عذرا ← {["..data.first_name_.."](T.ME/UUE_C)}\n ☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝑈𝑆𝐸𝑅𝑆 𝑀𝐴𝑅𝑉𝐸𝐿',url="t.me/UU_MARVEL"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BEK_ROG/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'يوتيوب' or text == 'بحث' or text == 'اليوتيوب' or text == 'يوتيوب' then
local Text = [[
 ☆ بوت تحميل من يوتيوب ☆
...
☆ لعبة البـات ← بات
༆╾╾╾╾[🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎](t.me/UUE_C)╾╾╾╾༆
☆ ᑕᕼ -> [🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎](t.me/UUE_C)
༆╾╾╾╾[🅜︎🅐︎🅡︎🅥︎🅔︎🅛︎](t.me/UUE_C)╾╾╾╾༆
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☆', url="t.me/UUE_C"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
{{text = '𝚂??𝚄??𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☆', url="t.me/UUE_C"}},
}  
local msg_id = msg.id_/2097152/0.5 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☆ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UUE_C')..') \n ☆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UUE_C')..') \n ☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n☆تم قفل البوتات بالطرد\n☆تم وضع الايدي بدون صوره\n☆تم قفل التكرار بالطرد\n☆تم قفل الروابط\n☆تم قفل التوجيه\n☆تم قفل الملصقات\n☆تم قفل المتحركه\n☆تم قفل الفيديو\n☆تم قفل السب\n☆تم قفل التعديل\n☆تم قفل الفارسيه\n☆تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UUE_C')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'UUE_C')..')'
status  = '\n ☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆ العضو ← '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'UUE_C')..')'..'\n ☆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local curlm = 'curl "'..'https://api.telegram.org/bot'..token..'/sendAudio'..'" -F "chat_id='.. msg.chat_id_ ..'" -F "document=@'..''..textntk..'.mp3'..'"' io.popen(curlm) 
end   
end
...
database:set(bot_id.."UUE_C:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."UUE_C:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."UUE_C:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
{
{text = '??𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/UUE_C "},
},
{
{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"},
},
