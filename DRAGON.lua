...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/G_K_00)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/G_K_00"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'ديكا' or text == 'ديكابريو' then
local Text = [[
☆ المبرمج ديكا ☆
]]
keyboard = {} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n☆تم قفل البوتات بالطرد\n☆تم وضع الايدي بدون صوره\n☆تم قفل التكرار بالطرد\n☆تم قفل الروابط\n☆تم قفل التوجيه\n☆تم قفل الملصقات\n☆تم قفل المتحركه\n☆تم قفل الفيديو\n☆تم قفل السب\n☆تم قفل التعديل\n☆تم قفل الفارسيه\n☆تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'G_K_00')..')')   
end,nil) 
end
