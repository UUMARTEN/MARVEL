...
if text == 'فين البوت' or text == 'بوت مين' or text == '/start' or text == '/start"..sudos.UserName.."' then
...
keyboard.inline_keyboard = { 
{
{text = 'غنيلي', url="t.me/G_K_00/127},{text = 'استوري',url="t.me/G_K_00/129"},
},
{
{text = 'ثيم',url="t.me/G_K_00/126"},{text = 'صور انيمي',url="t.me/G_K_00/125"},
},
{
{text = 'خلفيات',url="t.me/G_K_00/131"},{text = 'مريم',url="t.me/G_K_00/132"},
},
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☆', url="t.me/G_K_00"}, 
},
...
if Text == '/marten' or text == 'مميزات' then
if not Mod(data) then
local notText = 'المعذره هذا الامر ليس لك..🙂♥️'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
...
{
{text = '☆ اوامر التسليه .', callback_data="/help7"},{text = '☆ مميزات .',callback_data="/marten"},
},
{
