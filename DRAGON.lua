...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "༆╾╾╾╾[𝐬𝐨𝐮𝐫𝐜𝐞 𝐦𝐚𝐫𝐯𝐞𝐥╾╾╾╾〩 ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "༆╾╾╾╾[𝐬𝐨𝐮𝐫𝐜𝐞 𝐦𝐚𝐫𝐯𝐞𝐥╾╾╾╾〩 •═════•| • 𝐦 𝐚 𝐫 𝐯 𝐞 𝐥 • |•═════• ┉"
exit 1
fi
if [ ! $token ]; then
echo "•═════•| • 𝐦 𝐚 𝐫 𝐯 𝐞 𝐥 • |•═════• •═════•| • 𝐦 𝐚 𝐫 𝐯 𝐞 𝐥 • |•═════• ┉ ┉"
...
if not DevSoFi(msg) then
local Text = [[
 كلم اي مطور هينصبلك بوتك
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐝𝐞𝐯 𝐛𝐫𝐢𝐧𝐠𝐨', url="t.me/BringoXv"}},
{{text = '𝐝𝐞𝐯 𝐝𝐞𝐤𝐚', url="t.me/YY_OIO"}},
...
local Text = ' قسم المبرمجين لدخول الي حسابتهم'
local Key = {
{'•═════•| • 𝐦 𝐚 𝐫 𝐯 𝐞 𝐥 • |•═════•'},
...
{
{text = ' اوامر التسليه ', callback_data="/help7"},{text = ' المميزات والالعا.',callback_data="/uumarten"},
},
{
{text = ' اوامر القفل ', callback_data="/help1"},{text = ' اوامر التعطيل ', callback_data="/help2"},
},
...
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = 'القائمه الرائسيه', callback_data="/uumarten"}},
{{text = '𝐬𝐨𝐮𝐫𝐜?? 𝐦𝐚𝐫𝐯𝐞𝐥', url="t.me/G_K_00"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
