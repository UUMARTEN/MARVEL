...
if [ ! $token ]; then
echo "┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄ ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE zepellno.lua \e[0m"
echo "┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄ ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄"
exit 1
fi
...
local f = io.open("./zepellno.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
...
local config = loadfile("./zepellno.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1851380322,800,1839082644}   
...
var = true  
elseif tonumber(user_id) == tonumber(800) then
var = true  
...
{
{text = 'اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./zepellno.lua").botUserName.."?startgroup=start"},
},
}
...
if not DevSoFi(msg) then
local Text = [[
 ☆ سعر النصيب علي سورس روجين 
☆ طبعا مفيش اسعار تنصيب مجانا 
☆ لتوصل مع مبرمجين سورس روجين 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚍𝚎𝚟 𝚖𝚊𝚛𝚝𝚎𝚗',url="t.me/I_C_X"},{text = '𝚍𝚎𝚟 𝚎𝚕𝚔𝚊𝚋𝚘𝚘𝚜', url="t.me/G_W_P"}},
{{text = '𝚝𝚠𝚊𝚜𝚘𝚘𝚕 𝚛𝚘𝚘𝚐𝚎𝚗',url="t.me/TW_DRAGON_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
☆ سعر السورس عندنا
☆ مش هقولك بفلوس طبعا السورس علينا
☆ والسيرفر عليك بشرط واحد السيرفرات من العالمي
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/ROOGEN1/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مبرمجين السورس', url="t.me/US_DRAGON"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/US_DRAGON/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج الكابوس لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'الكابوس' or text == 'كابوس' or text == 'محمد' then
local Text = [[
المبرمج الكابوس  لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
local Text ='اكتب ثيم وسيتم اختيار ثيم اخر' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local Text ='مرحبا إليك تويت بالصوره❤️🌚' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./zepellno.lua").botUserName.."?startgroup=start"}}, 
} 
...
if tonumber(result.sender_user_id_) == tonumber(800) then  
send(msg.chat_id_, msg.id_, " ✧ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(800) then
send(msg.chat_id_, msg.id_, " ✧ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(800) then  
send(msg.chat_id_, msg.id_, " ✧ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_, t..'┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄\nاضغط علي الاسم ليتم نسخه\n┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄ٴ\n ✧ ❲[𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗](t.me/SO_ROGEN)❳ ✧ ')
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝❤️](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺❤️](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عوزه تزنقني..🙂😹](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بخخ ياتت🙂??](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عووو ياتت..🙂😹](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..🙂😹](t.me/SO_ROGEN)')
return false
end
end
end
