...
if text == '/start' or text == 'رجوع' or text == '🅱︎🅰︎🅲︎🅺︎' then
...
if DevSoFi(msg) then
local bl = 'مرحبا بك في سورس روجين 🧚‍♀❤️ \n انت المطور الاساسي واليك كيبورد التحكم في البوت 😊❤️ \n [اضغط هنا وانضم الي قناه السورس](t.me/SO_ROGEN)'
local keyboard = {
	    {'معلوامات الكيبورد'},
...
if text == 'اوامر التفعيل والتعطيل' then
local bl = 'مرحبا بك في اوامر التفعيل والتعطيل...🌚❤️'
local keyboard = {
{'تفعيل التواصل','تعطيل التواصل'},
{'تفعيل الاذاعه','تعطيل الاذاعه'},
{'تفعيل المغادرة','تعطيل المغادره'},
...
{
{text = 'اضف البوت الي مجموعتك ↯', url = "https://t.me/"..botUserName.."?startgroup=start"},
},
}
local msg_id = msg.id_/2097152/0.5
...
'اسمي  '..Namebot..' يوتكه🙈🍑',
'انت تعرف انو بوت '..Namebot..' متنصب علي سورس روجين🙈♥️',
} 
Namebot = DRAGON_Msg[math.random(#DRAGON_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'روجين').." غادر" or text == 'بوت غادر' then  
...
send(msg.chat_id_,msg.id_, '[☆ هنا فقلبي..😹♥️](t.me/SO_ROGEN') 
return false
end

if text == 'اوف' or text == 'يوه' then
send(msg.chat_id_,msg.id_, '[☆ يتي القمر زعلان من اي..🥺🔥](t.me/SO_ROGEN') 
return false
end

if text == 'بخ' or text == 'عو' then
send(msg.chat_id_,msg.id_, '[☆ يوه خضتني ياسمك اي..🥺💘](t.me/SO_ROGEN) ') 
return false
end
...
send(msg.chat_id_, msg.id_,'لا يوجد حساب بهذا اليوزر ☆ ') 
return false  
end
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄
 اختر الامر الذي تريدها .↑┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄
ده من الازرار بلاسفل . ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[𝒓𝒐𝒐𝒈𝒆𝒏 ](t.me/SO_ROGEN)❳ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄
 اختر العبه الذي تريدها .↑┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄
ده من الازرار بلاسفل . ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[𝒓𝒐𝒐𝒈𝒆𝒏 ](t.me/SO_ROGEN)❳ 
]]
...
{
{text = '🆁︎🅾︎🅾︎🅶︎🅴︎🅽︎', url="t.me/SO_ROGEN"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
