...
if text == 'فين البوت' or text == 'بوت مين' or text == '/start' or text == '/start"..botUserName.."' then
...
keyboard.inline_keyboard = {
{
{text = 'العاب السورس', callback_data="/devMR"},{text = 'مميزات', callback_data="/deVmR"},
},
{
{text = 'العاب متطوره', callback_data="/devMR"},
},
{
...
if text == 'قران' or text == 'القران' then
local Text = [[ 
...
keyboard.inline_keyboard = {
{
{text = 'الفاتحه', callback_data="/gg1"},{text = 'البقرة', callback_data="/gg3"},
},
{
{text = 'ال عمران', callback_data="/gg2"},
},
{
{text = 'العوده', callback_data="/gg100"},
},
{
{text = '𝑠𝑜𝑢𝑟𝑐𝑒 𝑚𝑎𝑟𝑣𝑒𝑙', url="t.me/G_K_00"},
},
...
local Text='اتفضل 😊❤'
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Q_ROGEN/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
---------------end new mr
